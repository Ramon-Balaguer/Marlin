...
#define STRING_CONFIG_H_AUTHOR "(Ramon Balaguer, default config)" // Who made the changes.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 6, -45, 0 }
...
#define X_BED_SIZE 200 //RBA: O 210??
#define Y_BED_SIZE 200 //RBA: O 210??
